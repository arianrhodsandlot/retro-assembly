...
export function VirtualControllerPortrait() {
  ...
  if (hideButtons) {
    return (
      <div className='flex size-full justify-end p-10 portrait:flex landscape:hidden'>
  ...
  return (
    <div className='flex size-full flex-col px-2 py-10 portrait:flex landscape:hidden'>
