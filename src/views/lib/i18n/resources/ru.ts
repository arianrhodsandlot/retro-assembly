...
const translation: Translation = {
  ...
  'Click here to launch the game': 'Нажмите здесь, чтобы запустить игру',
  Close: 'Закрывать',
  'Configure gamepads': 'Настройка геймпадов',
  'Configure Keyboards': 'Настройка клавиатуры',
  Confirm: 'Подтверждать',
  'Connect your controller and press any button to begin':
    'Подключите контроллер и нажмите любую кнопку, чтобы начать.',
  'Continue with your own library': 'Продолжить работу с собственной библиотекой',
  'Enjoy legal free games.': 'Наслаждайтесь легальными бесплатными играми.',
  Exit: 'Выход',
  'Failed to load games.': 'Не удалось загрузить игры.',
  'Failed to load state list': 'Не удалось загрузить список состояний.',
  'Fast forward': 'Перемотка вперед',
  'Gameplay controller-keyboard mappings': 'Сопоставление контроллера игрового процесса и клавиатуры',
  'Games are loaded from': 'Игры загружаются с',
  ...
  Logout: 'Выйти',
  'May need to login again after 24h.': 'Возможно, потребуется снова войти в систему через 24 часа.',
  Move: 'Двигаться',
  'Next console': 'Следующая консоль',
  'Not encouraged because it only provides limited usage(100 users) for unverified apps.':
    'Не рекомендуется, поскольку обеспечивает ограниченное использование (100 пользователей) непроверенных приложений.',
  'Notice:': 'Уведомление:',
  OK: 'ХОРОШО',
  or: 'или',
  ...
  'Some actions are not available while playing the public library.':
    'Некоторые действия недоступны во время игры в публичной библиотеке.',
  'Star me on GitHub': 'Отметьте меня на GitHub',
  'Synchronize your games and saves across multiple devices.':
    'Синхронизируйте свои игры и сохранения на нескольких устройствах.',
  'Tap here to launch the game': 'Нажмите здесь, чтобы запустить игру',
  ...
  'to open/hide this menu.': 'чтобы открыть/скрыть это меню.',
  'to rewind while playing.': 'для перемотки назад во время игры.',
  'To select a ROMs directory from your Dropbox, you need to sign in with Dropbox first.':
    'Чтобы выбрать каталог ПЗУ из вашего Dropbox, вам необходимо сначала войти в систему Dropbox.',
  'To select a ROMs directory from your Google Drive, you need to sign in with Google first.':
    'Чтобы выбрать каталог ПЗУ на вашем Google Диске, вам необходимо сначала войти в систему с помощью Google.',
  'To select a ROMs directory from your OneDrive, you need to sign in with Microsoft first.':
    'Чтобы выбрать каталог ПЗУ в OneDrive, вам необходимо сначала войти в систему Microsoft.',
  'Try public library': 'Попробуйте публичную библиотеку',
  'UI controls': 'Элементы управления пользовательского интерфейса',
  Version: 'Версия',
